...
#this line of code is to unlist this column, otherwise I could not save the final dataset as a txt file using write.table
extractedData$ACTIVITY = unlist(lapply(extractedData$ACTIVITY, activityNameMapper))
